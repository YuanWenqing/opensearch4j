...
public interface Filters {
  interface Values {
    ...
    static RelationalFilterCond ne(String field, Object value) {
      return new RelationalFilterCond(Field.of(field), RelationalFilterCond.RelationalOp.NE, Value.of(value));
    }

    static RelationalFilterCond lt(String field, Object value) {
      return new RelationalFilterCond(Field.of(field), RelationalFilterCond.RelationalOp.LT, Value.of(value));
    }

    static RelationalFilterCond lte(String field, Object value) {
      return new RelationalFilterCond(Field.of(field), RelationalFilterCond.RelationalOp.LTE, Value.of(value));
    }

    static RelationalFilterCond gt(String field, Object value) {
      return new RelationalFilterCond(Field.of(field), RelationalFilterCond.RelationalOp.GT, Value.of(value));
    }

    static RelationalFilterCond gte(String field, Object value) {
      return new RelationalFilterCond(Field.of(field), RelationalFilterCond.RelationalOp.GTE, Value.of(value));
    }
  }

  interface Fields {
    static RelationalFilterCond eq(String field1, String field2) {
      return new RelationalFilterCond(Field.of(field1), RelationalFilterCond.RelationalOp.EQ, Field.of(field2));
    }

    static RelationalFilterCond ne(String field1, String field2) {
      return new RelationalFilterCond(Field.of(field1), RelationalFilterCond.RelationalOp.NE, Field.of(field2));
    }

    static RelationalFilterCond lt(String field1, String field2) {
      return new RelationalFilterCond(Field.of(field1), RelationalFilterCond.RelationalOp.LT, Field.of(field2));
    }
    ...
    static RelationalFilterCond gt(String field1, String field2) {
      return new RelationalFilterCond(Field.of(field1), RelationalFilterCond.RelationalOp.GT, Field.of(field2));
    }
